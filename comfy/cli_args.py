...
parser.add_argument("--tpu-profile", type=str, default="krea2-1920x1080", choices=["krea2-1920x1080", "krea2", "pid", "upscaler", "krea2-pid", "krea2_upscaler", "krea2-upscaler"], help="TPU execution profile. 'krea2-1920x1080' is the Phase 1 fixed profile (still accepted); 'krea2' enables dynamic sizes (1024x1024, 1080x1920, other ~1 Mpx, any multiple of 8 in 512–2048 with area ≤2.1 Mpx). 'pid'/'upscaler' is the PiD 4x upscaler fixed profile (1024x576 -> 4096x2304). 'krea2-pid'/'krea2_upscaler' is the fused Krea2 1024x576 -> PiD 4096x2304 pipeline. All share BF16/xla mesh.")
